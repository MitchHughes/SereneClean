	...
	public static partial class Texts
	{
		...
		public static class Forms
		{
			public static class Membership
			{
				...
				{
					public static LocalText EmailSubject = "Reset Your SereneClean Password";
				...
				{
					public static LocalText ActivateEmailSubject = "Activate Your SereneClean Account";
					...
					public static LocalText FormTitle = "Sign up for SereneClean";
		...
		public static class Navigation
		{
			...
			public static LocalText SiteTitle = "SereneClean";
		}
