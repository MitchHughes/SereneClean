...
(function (SereneClean) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return SereneClean.LanguageList.getValue();
            };
    ...
    })(Northwind = SereneClean.Northwind || (SereneClean.Northwind = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var Northwind;
    (function (Northwind) {
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneClean.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SereneClean.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SereneClean) {
    ...
    })(Common = SereneClean.Common || (SereneClean.Common = {}));
})(SereneClean || (SereneClean = {}));
...
(function (SereneClean) {
    ...
    (function (Northwind) {
        ...
        }(SereneClean.Common.GridEditorDialog));
...
(function (SereneClean) {
    ...
    (function (Northwind) {
        ...
        }(SereneClean.Common.GridEditorBase));
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneClean.BasicProgressDialog();
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = SereneClean.BasicSamples || (SereneClean.BasicSamples = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(SereneClean.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneClean.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneClean.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (SereneClean) {
    ...
    })(Membership = SereneClean.Membership || (SereneClean.Membership = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var Membership;
...
(function (SereneClean) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('SereneClean');
    })(ScriptInitialization = SereneClean.ScriptInitialization || (SereneClean.ScriptInitialization = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var Common;
...
(function (SereneClean) {
    ...
    })(Administration = SereneClean.Administration || (SereneClean.Administration = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var Administration;
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SereneClean.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SereneClean.BasicSamples || (SereneClean.BasicSamples = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SereneClean.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return SereneClean.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SereneClean.BasicSamples || (SereneClean.BasicSamples = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
...
(function (SereneClean) {
    ...
    SereneClean.BasicProgressDialog = BasicProgressDialog;
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var DialogUtils;
    ...
    })(DialogUtils = SereneClean.DialogUtils || (SereneClean.DialogUtils = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var Common;
...
(function (SereneClean) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneClean.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneClean.LanguageList || (SereneClean.LanguageList = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var Common;
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneClean.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneClean.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneClean.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Northwind.SupplierGrid));
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Northwind.ProductGrid));
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneClean.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneClean.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneClean.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneClean.Northwind.ProductService.baseUrl; };
    ...
    (function (BasicSamples) {
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                var fld = SereneClean.Northwind.OrderRow.Fields;
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = SereneClean.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
        ...
        }(SereneClean.Northwind.OrderGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneClean.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneClean.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneClean.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneClean.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, SereneClean.Northwind.OrderRow.Fields.ShipCountry);
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneClean.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneClean.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneClean.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneClean.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = SereneClean.Northwind.ProductRow.Fields;
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneClean.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Northwind.OrderDetailsEditor));
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneClean.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneClean.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneClean.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneClean.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new SereneClean.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = SereneClean.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(SereneClean.Northwind.OrderDetailDialog));
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = SereneClean.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                this.form.Discount.addValidationRule(this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SereneClean.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SereneClean.Northwind.ProductRow.lookupKey;
            };
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SereneClean.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SereneClean.Northwind.CustomerDialog));
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Northwind.CustomerGrid));
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SereneClean.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SereneClean.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SereneClean.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SereneClean.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SereneClean.Northwind.OrderService.baseUrl; };
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SereneClean.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SereneClean.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SereneClean.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SereneClean.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SereneClean.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SereneClean.Northwind.OrderService.baseUrl; };
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Northwind.OrderDialog));
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    SereneClean.Northwind.CategoryService.Retrieve({
        ...
        }(SereneClean.Northwind.CategoryDialog));
...
(function (SereneClean) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneClean.Northwind.CategoryGrid));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneClean.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneClean.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneClean.Northwind.OrderDialog();
                        ...
                        var chai = SereneClean.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneClean.Northwind.EmployeeRow.getLookup().items
...
(function (SereneClean) {
    ...
    })(Authorization = SereneClean.Authorization || (SereneClean.Authorization = {}));
})(SereneClean || (SereneClean = {}));
var SereneClean;
(function (SereneClean) {
    var Administration;
...
//# sourceMappingURL=SereneClean.Web.js.map